...
async function onLoadFunction(){
        const newsList = await fetch('https://newsapi.org/v2/top-headlines?apiKey=09f3023e7b154f1582dbf07379774e0a&country=ph&category=&page='+PAGE+'&pageSize='+PAGE_SIZE+'')
                            .then(res => res.json())
                            .then(data => data)
